...
class RoleModel extends CI_Model {
	...
	var $table = 'roles';
    var $public_column = ['id', 'name', 'description'];
    ...
    var $column_select = ['id', 'name', 'description'];
    var $column_order  = [null, 'name', 'description', null, null];
    var $column_search = ['name', 'description'];
